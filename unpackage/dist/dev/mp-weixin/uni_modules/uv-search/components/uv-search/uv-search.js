...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.o($options.clickIcon),
    b: common_vendor.p({
      size: _ctx.searchIconSize,
      name: _ctx.searchIcon,
      color: _ctx.searchIconColor ? _ctx.searchIconColor : _ctx.color
    }),
    c: common_vendor.o((...args) => $options.blur && $options.blur(...args)),
    d: $data.keyword,
    e: common_vendor.o((...args) => $options.search && $options.search(...args)),
    f: common_vendor.o((...args) => $options.inputChange && $options.inputChange(...args)),
    g: _ctx.disabled,
    h: common_vendor.o((...args) => $options.getFocus && $options.getFocus(...args)),
    i: _ctx.focus,
    j: _ctx.maxlength,
    k: _ctx.placeholder,
    l: `color: ${_ctx.placeholderColor}`,
    m: common_vendor.s({
    ...
    n: common_vendor.s(_ctx.inputStyle),
    o: $data.keyword && _ctx.clearabled && $data.focused
    ...
    s: common_vendor.s(_ctx.$uv.addStyle(_ctx.boxStyle)),
    t: common_vendor.t(_ctx.actionText),
    v: common_vendor.s(_ctx.actionStyle),
    w: common_vendor.n(($options.showActionBtn || $data.show) && "uv-search__action--active"),
    x: common_vendor.o((...args) => $options.custom && $options.custom(...args)),
    y: common_vendor.o((...args) => $options.clickHandler && $options.clickHandler(...args)),
    z: common_vendor.s({
      margin: _ctx.margin
    }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-46cbdd03"], ["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzdsxcx/uni_modules/uv-search/components/uv-search/uv-search.vue"]]);
