...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    G: common_vendor.o((...args) => _ctx.onAddgroupapp && _ctx.onAddgroupapp(...args)),
    H: common_vendor.o((...args) => _ctx.onChooseaddress && _ctx.onChooseaddress(...args)),
    I: common_vendor.o((...args) => _ctx.onSubscribe && _ctx.onSubscribe(...args)),
    J: common_vendor.o((...args) => _ctx.onLogin && _ctx.onLogin(...args)),
    K: common_vendor.o((...args) => _ctx.onIm && _ctx.onIm(...args)),
    L: common_vendor.s($options.baseColor),
    M: common_vendor.s(_ctx.$uv.addStyle(_ctx.customStyle)),
    N: common_vendor.o((...args) => $options.clickHandler && $options.clickHandler(...args)),
    O: common_vendor.n($options.bemClass)
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-ae8e42c7"], ["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzdsxcx/uni_modules/uv-button/components/uv-button/uv-button.vue"]]);
