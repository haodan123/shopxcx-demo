...
const _sfc_main = {
  __name: "Location",
  setup(__props) {
    const CityName = common_vendor.ref("北京");
    const HotCity = common_vendor.ref(["北京", "深圳", "上海", "成都", "广州", "金华"]);
    const LatterName = common_vendor.ref([
      "A",
      "B",
      "C",
      "D",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-8e9aba32"], ["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzdsxcx/pages/home/pages/Location/Location.vue"]]);
