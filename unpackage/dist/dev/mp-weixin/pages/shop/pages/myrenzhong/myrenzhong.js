  ...
  setup(__props) {
    ...
    const toWhat = () => {
      common_vendor.index.navigateTo({
        url: `/pages/home/pages/myrenzhongDetail/myrenzhongDetail?id=${1}`
      });
    };
    return (_ctx, _cache) => {
      return {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-66278d80"], ["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzdsxcx/pages/shop/pages/myrenzhong/myrenzhong.vue"]]);
