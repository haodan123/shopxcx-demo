  ...
  setup(__props) {
    ...
    const buy = () => {
      ...
      common_vendor.index.navigateTo({
        url: `/pages/order/pages/creatRzOrder/creatRzOrder?shop=${JSON.stringify(shopData.value)}`
      });
    };
    return (_ctx, _cache) => {
      return {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzdsxcx/pages/goods/pages/rzGoods/rzGoods.vue"]]);
